...
export default function ReadoraPublishing() {
  return (
    <>
      <div className="svc-detail">
        ...
        <div className="svc-detail__hero">
          ...
          <p className="svc-detail__subtitle">Readora Publishing is the premier professional book publishing service for entrepreneurs, consultants, and executives with completed manuscripts.</p>
