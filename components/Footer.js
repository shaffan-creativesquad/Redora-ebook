...
const servicesLinks = [
  ...
  ['Readora Publishing', '/services/publishing'],
    ...
    <footer style={{
      ...
      <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <div className="lg:col-span-1" style={{ paddingRight: '0.65rem' }}>
            <div style={{ marginBottom: '0.9rem' }}>
              <a href="/" style={{ textDecoration: 'none' }}>
                <span style={{ fontSize: '1.6rem', fontWeight: 800, color: '#f3f4f6', fontFamily: 'var(--font-playfair), Georgia, serif', letterSpacing: '-0.03em', lineHeight: 1 }}>
                  Readora
                </span>
              </a>
            </div>
            <p style={{ color: '#b8b8b8', fontSize: '0.9rem', lineHeight: 1.58, margin: '0 0 1.15rem', maxWidth: '32ch' }}>
              Turning expertise into published books — and published books into careers, clients, and credibility.
            </p>
        ...
        <div style={{
          ...
          <p style={{ color: '#8a8a8a', fontSize: '0.82rem', margin: 0 }}>© 2026 Readora. All rights reserved.</p>
