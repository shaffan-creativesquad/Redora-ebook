...
const reasons = [
  ...
  },
  {
    ...
    desc: 'Readora writers and editors have traditional publishing credits, MFAs, and 10–15 years of experience. Peaceful Profits is built around direct-response copywriting craft. Different output, different shelf life.',
  },
  {
    num: '03',
    ...
    <div className="vs-page">
      ...
      <section className="vs-page__hero">
        <div className="vs-page__container">
          ...
          <p className="vs-page__subhead">If you&apos;re considering Peaceful Profits, you&apos;re looking for a book that drives business. Peaceful Profits builds books as funnels for high-ticket coaching offers. Readora builds books as long-term brand and legacy assets. Decide which one matches what you actually need.</p>
      ...
      <section className="vs-page__section" id="compare">
        <div className="vs-page__container">
          ...
          <h2>Peaceful Profits vs. <em>Readora</em></h2>
      ...
      <section className="vs-page__quote">
        <div className="vs-page__container">
          ...
          <p className="vs-page__quote-attrib">— From the Readora internal Competitive Comparison briefing for Peaceful Profits.</p>
        </div>
      </section>
      ...
      <section className="vs-page__section">
        <div className="vs-page__container">
          ...
          <h2>Three reasons people choose Readora<br />over Peaceful Profits.</h2>
