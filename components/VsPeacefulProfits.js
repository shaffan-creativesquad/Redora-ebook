...
const themPoints = [
  'Copy-first ghostwriting (Source: Competitive Comparison)',
  'Books written as marketing assets, not for depth or prestige',
  'Positioning: book-as-lead-magnet for high-ticket sales',
  'Target client: coaches, marketers, direct-response entrepreneurs',
  'Pricing: $30,000–$50,000',
]

const usPoints = [
  'Editorial team with traditional publishing credits, MFAs, and 10–15 years experience',
  'Books built around what they unlock: speaking, clients, board seats, legacy',
  '3,000+ authors published; Navy SEALs, billionaires, and Nobel Prize winners on the roster',
  'Target client: founders, CEOs, consultants, executives, thought leaders',
  'Flat-fee pricing: $29K Publishing · $56K Professional · $135K Elite. No upsells.',
]

const reasons = [
  {
    num: '01',
    title: 'You keep 100% of everything.',
    desc: 'Your IP. Your royalties. Your rights. Your story. Forever. No funnel licenses, no clawbacks, no marketing-rights fine print.',
  },
  {
    num: '02',
    title: 'Editorial firepower is the difference.',
    desc: 'Scribe writers and editors have traditional publishing credits, MFAs, and 10–15 years of experience. Peaceful Profits is built around direct-response copywriting craft. Different output, different shelf life.',
  },
  {
    num: '03',
    title: 'Your book outlives the funnel.',
    desc: 'A funnel optimizes for the next 90 days. Our most successful authors use their books to land speaking gigs, close high-ticket clients, and build authority five and ten years out.',
  },
]
...
export default function VsPeacefulProfits() {
  return (
    <div className="vs-page">
      {/* Hero */}
      <section className="vs-page__hero">
        <div className="vs-page__container">
          <span className="vs-page__eyebrow">Peaceful Profits Alternative</span>
          <h1>You can build a <em>funnel</em>.<br />Or you can build a <em>legacy</em>.</h1>
          <p className="vs-page__subhead">If you&apos;re considering Peaceful Profits, you&apos;re looking for a book that drives business. Peaceful Profits builds books as funnels for high-ticket coaching offers. Scribe builds books as long-term brand and legacy assets. Decide which one matches what you actually need.</p>
      ...
      <section className="vs-page__section" id="compare">
        <div className="vs-page__container">
          ...
          <h2>Peaceful Profits vs. <em>Scribe Media</em></h2>
          ...
          <div className="vs-page__two-col">
            <div className="vs-page__col vs-page__col--them">
              <div className="vs-page__col-label">Peaceful Profits</div>
              <h3>Copy-first ghostwriting group built around funnel ROI. Books are written as marketing assets — not for depth or prestige.</h3>
      ...
      <section className="vs-page__quote">
        <div className="vs-page__container">
          ...
          <p className="vs-page__quote-lead">&ldquo;They&apos;re selling a funnel disguised as a book. We create assets that build brand, credibility, and legacy — not just a short-term lead gen bump.&rdquo;</p>
          <p className="vs-page__quote-attrib">— From the Scribe Media internal Competitive Comparison briefing for Peaceful Profits.</p>
        </div>
      </section>
      ...
      <section className="vs-page__section">
        <div className="vs-page__container">
          ...
          <h2>Three reasons people choose Scribe<br />over Peaceful Profits.</h2>
      ...
      <section className="vs-page__final-cta" id="consult">
        <div className="vs-page__container">
          ...
          <p>15-minute consult. No pressure. We&apos;ll genuinely tell you if Peaceful Profits is the better fit for what you actually need.</p>
          <a href="/consult" className="vs-page__btn vs-page__btn--primary">Book a Free Consult</a>
        </div>
      </section>
