...
export const metadata = {
  title: 'Free Resources | Scribe Media',
  description: 'Everything you need to write, publish, and market a book that builds your business and authority. Podcasts, books, blog, courses, and more from Scribe Media.',
}
        ...
        <div className="fr">
          ...
          <div className="fr__section">
            ...
            <div className="fr__grid">
              ...
              <a href="/scribe-method-book" className="fr__card fr__card--featured">
                ...
                <h3>The Scribe Method</h3>
                <p>Our Wall Street Journal bestseller lays out the entire Scribe process for writing and publishing a non-fiction book. Read it free online.</p>
                <span className="fr__card-link">Read the Book →</span>
              </a>

              <a href="/blog" className="fr__card">
                <div className="fr__card-icon">✍️</div>
                <h3>The Scribe Blog</h3>
                <p>Guides on writing, editing, publishing, book marketing, and launching from Scribe co-founders and bestselling authors.</p>
            ...
            <div className="fr__grid">
              ...
              <a href="/reviews" className="fr__card">
                ...
                <p>Read what real authors say about working with Scribe. Hundreds of reviews from entrepreneurs, executives, and experts.</p>
            ...
            <div className="fr__grid">
              ...
              <a href="/blog/tag/book-bites" className="fr__card">
                <div className="fr__card-icon">🍔</div>
                <h3>Book Bites</h3>
                <p>Short, actionable summaries of the best Scribe-published books. Get the key takeaways in under 5 minutes.</p>
              ...
              <a href="/faq" className="fr__card">
                <div className="fr__card-icon">❓</div>
                <h3>FAQs</h3>
                <p>Common questions about the Scribe process, timelines, pricing, and what to expect when writing your book.</p>
              ...
              <a href="/consult" className="fr__card fr__card--featured">
                ...
                <p>Talk to our team about your book idea, goals, and which Scribe service is the right fit. No obligation, no pressure.</p>
          ...
          <section className="fr-cta">
            <div className="fr-cta__inner">
              ...
              <p className="fr-cta__sub">Join 57,000+ readers receiving expert writing and publishing insights from our Scribe team.</p>
              ...
              <div className="fr-cta__form-wrap">
                <div className="fr-cta__form-placeholder">
                  ...
                  <span style={{ fontSize: '0.82rem', opacity: 0.7 }}>
                    In the meantime, email <a href="mailto:privacy@scribemedia.com" style={{ color: '#e02d2d' }}>privacy@scribemedia.com</a> to get in touch.
                  </span>
                </div>
