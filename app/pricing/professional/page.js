...
const INCLUDED = [
  ...
  { icon: 'ph ph-chats',           label: '10 Content Interviews',                   detail: 'Two-hour sessions. What you say on these calls becomes your book.' },
  { icon: 'ph ph-pen-nib',         label: 'Professional Manuscript Writing',         detail: 'Our writers craft your book from your interviews' },
...
<p><strong>Interior Layout Design & eBook Conversion:</strong> An interior layout designer will craft the interior for your hardcover, paperback, and eBook editions. You can provide up to 25 print-ready visual images.</p>
...
export default function PricingProfessional() {
  ...
  const total = BASE_PRICE + imprintCost + addonTotal + (extraAuthors * EXTRA_AUTHOR_PRICE) - (returningAuthor ? RETURNING_DISCOUNT : 0)
        ...
        <div className="pub-layout">
                ...
                {showCustomize && (
                  <div className="pub-card" style={{ marginTop: 0 }}>
                    ...
                    <div className="pub-stepper-row">
                      <div>
                        <div style={{ fontSize: '14px', fontWeight: 600, color: '#fff' }}>Additional Author</div>
                        <div style={{ fontSize: '12px', color: '#a0a0a0' }}>+{fmt(EXTRA_AUTHOR_PRICE)} per additional author</div>
                      </div>
                      <div className="pub-stepper">
                        <button className="pub-stepper__btn" disabled={extraAuthors === 0} onClick={() => setExtraAuthors(v => Math.max(0, v - 1))}>−</button>
                        <span className="pub-stepper__val">{extraAuthors}</span>
                        <button className="pub-stepper__btn" onClick={() => setExtraAuthors(v => v + 1)}>+</button>
                      </div>
                    </div>

                    <div className="pub-card-section-label" style={{ marginTop: '8px' }}>Returning Author</div>
                    <label className="pub-check" style={{ marginBottom: 0 }}>
                ...
                <div className="pub-agreement" dangerouslySetInnerHTML={{ __html: AGREEMENT_TEXT + `
                  ...
                  <table>
                    <tbody>
                      ...
                      ${returningAuthor ? `<tr><td>Returning Author Discount</td><td style="text-align:right;color:#4ade80;font-weight:600;">-${fmt(RETURNING_DISCOUNT)}</td></tr>` : ''}
          ...
          <div className="pub-sidebar">
            <div className="pub-summary">
              ...
              {returningAuthor && <div className="pub-summary__line"><span className="label">Returning author discount</span><span className="value" style={{ color: '#4ade80' }}>-{fmt(RETURNING_DISCOUNT)}</span></div>}
