...
const tiers = [
  {
    ...
    features: [
      ...
      'Up to 50,000 words',
      'Thornfield Books Press imprint',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Full publishing and distribution',
      'Up to 50,000 words',
      'Ember Press Publishing imprint',
    ],
    cta: 'Configure Your Package',
  ...
  },
  {
    ...
    features: [
      ...
      'Up to 40 hours of interviews with your writer',
      'Three days of in-person time with your writer',
...
const faqs = [
  {
    ...
    a: 'Every Readora package includes professional editing, cover design, interior layout, audiobook production, publishing, and distribution to Amazon, Barnes & Noble, Apple Books, Kobo, Google Play, and other major online retailers. Higher tiers include writing support and additional services.',
  },
  {
