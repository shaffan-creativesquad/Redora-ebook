      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/the-only-software-you-need-to-write-a-book-is-already-on-your-computer" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">The Only Software You Need To Write A Book Is Already On Your Computer</span>
            </a>
            <a href="/readora-method-book/about-the-authors" className="chapter__nav-link chapter__nav-link--next">
