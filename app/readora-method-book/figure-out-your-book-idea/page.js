      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/figure-out-your-audience" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">Figure Out Your Audience</span>
            </a>
            <a href="/readora-method-book/the-north-star-check" className="chapter__nav-link chapter__nav-link--next">
