      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/design-your-book-layout" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">Design Your Book Layout</span>
            </a>
            <a href="/readora-method-book/how-to-pick-the-right-book-publishing-option" className="chapter__nav-link chapter__nav-link--next">
