...
export const metadata = {
  title: "What's The (Intangible) Impact Of A Book? | The Readora Method | Readora",
      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/how-to-make-money-with-your-book" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">How To Make Money With Your Book</span>
            </a>
            <a href="/readora-method-book/how-much-should-you-give-away-in-your-book" className="chapter__nav-link chapter__nav-link--next">
