      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/how-to-write-your-first-draft-the-readora-method" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">How to Write Your First Draft (The Readora Method)</span>
            </a>
            <a href="/readora-method-book/should-you-ask-people-for-feedback" className="chapter__nav-link chapter__nav-link--next">
