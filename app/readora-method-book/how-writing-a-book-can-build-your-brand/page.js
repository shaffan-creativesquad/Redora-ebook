      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/realistic-and-unrealistic-expectations-for-a-book" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">Realistic and Unrealistic Expectations For a Book</span>
            </a>
            <a href="/readora-method-book/how-to-make-money-with-your-book" className="chapter__nav-link chapter__nav-link--next">
