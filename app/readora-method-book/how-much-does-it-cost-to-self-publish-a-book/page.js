      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/how-to-pick-the-right-book-publishing-option" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">How To Pick The Right Book Publishing Options</span>
            </a>
            <a href="/readora-method-book/everything-you-need-to-know-about-self-publishing-book-distribution" className="chapter__nav-link chapter__nav-link--next">
