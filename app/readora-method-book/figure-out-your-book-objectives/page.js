      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/what-is-book-positioning-and-why-does-it-matter" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">What is Book Positioning (and Why Does it Matter)?</span>
            </a>
            <a href="/readora-method-book/figure-out-your-audience" className="chapter__nav-link chapter__nav-link--next">
