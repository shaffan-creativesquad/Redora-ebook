      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/how-to-edit-your-book" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">How to Edit Your Book</span>
            </a>
            <a href="/readora-method-book/picking-the-perfect-book-title" className="chapter__nav-link chapter__nav-link--next">
