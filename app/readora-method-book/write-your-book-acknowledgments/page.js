      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/write-your-book-dedication" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">Write Your Book Dedication</span>
            </a>
            <a href="/readora-method-book/write-your-book-foreword" className="chapter__nav-link chapter__nav-link--next">
