      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/how-to-properly-price-your-book" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">How To Properly Price Your Book</span>
            </a>
            <a href="/readora-method-book/how-much-does-it-cost-to-self-publish-a-book" className="chapter__nav-link chapter__nav-link--next">
