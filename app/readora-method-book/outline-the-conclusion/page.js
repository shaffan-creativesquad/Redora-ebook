      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/outline-the-introduction" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">Outline The Introduction</span>
            </a>
            <a href="/readora-method-book/how-to-create-your-book-writing-plan" className="chapter__nav-link chapter__nav-link--next">
