      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/how-people-really-judge-a-book" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">How People Really Judge A Book</span>
            </a>
            <a href="/readora-method-book" className="chapter__nav-link chapter__nav-link--next">
