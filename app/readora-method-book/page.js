import './readora-method-book.css'
...
const tocParts = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { num: 14, title: 'The Readora Guide to Writing Effective Nonfiction', slug: 'the-readora-guide-to-writing-effective-nonfiction' },
      { num: 15, title: 'How to Write Your First Draft (The Vomit Method)', slug: 'how-to-write-your-first-draft-the-vomit-method' },
      { num: 16, title: 'How to Write Your First Draft (The Readora Method)', slug: 'how-to-write-your-first-draft-the-readora-method' },
    ],
  },
  {
              ...
              <div className="sm-toc__part" key={part.title}>
                ...
                <ul className="sm-toc__chapters">
                  {part.chapters.map((ch) => (
                    <li key={ch.num}>
                      <a href={`/readora-method-book/${ch.slug}`} className="sm-toc__chapter-link">
