...
export default function ReadoraMethodDraftPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/how-to-write-your-first-draft-the-vomit-method" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">How to Write Your First Draft (The Vomit Method)</span>
            </a>
            <a href="/readora-method-book/how-to-edit-your-book" className="chapter__nav-link chapter__nav-link--next">
