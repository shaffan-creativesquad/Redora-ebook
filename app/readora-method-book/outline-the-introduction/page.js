...
export const metadata = {
  title: 'Outline The Introduction | The Readora Method | Readora',
      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__content">
            ...
            <p>Want more expert guidance on writing and publishing your book? Read <em>The Readora Method</em> for free online{' '}
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/create-your-book-outline" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">Create Your Book Outline</span>
            </a>
            <a href="/readora-method-book/outline-the-conclusion" className="chapter__nav-link chapter__nav-link--next">
