      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/introduction-why-write-a-book" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">Introduction: Why Write a Book?</span>
            </a>
            <a href="/readora-method-book/the-six-fears-you-could-face-writing-your-book" className="chapter__nav-link chapter__nav-link--next">
