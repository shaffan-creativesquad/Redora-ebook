      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/whats-the-intangible-impact-of-a-book" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">What&apos;s The (Intangible) Impact Of A Book?</span>
            </a>
            <a href="/readora-method-book/how-much-of-your-story-should-be-in-your-book" className="chapter__nav-link chapter__nav-link--next">
