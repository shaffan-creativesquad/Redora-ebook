      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/figure-out-your-book-objectives" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">Figure Out Your Book Objectives</span>
            </a>
            <a href="/readora-method-book/figure-out-your-book-idea" className="chapter__nav-link chapter__nav-link--next">
