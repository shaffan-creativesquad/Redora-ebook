      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/readora-method-book/should-you-ask-people-for-feedback" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">Should You Ask People For Feedback?</span>
            </a>
            <a href="/readora-method-book/write-your-book-dedication" className="chapter__nav-link chapter__nav-link--next">
