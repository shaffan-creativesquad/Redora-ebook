      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/scribe-method-book/how-to-create-your-book-writing-plan" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">How to Create Your Book Writing Plan</span>
            </a>
            <a href="/scribe-method-book/how-to-write-your-first-draft-the-vomit-method" className="chapter__nav-link chapter__nav-link--next">
