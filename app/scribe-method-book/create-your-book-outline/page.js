      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/scribe-method-book/the-north-star-check" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">The North Star Check</span>
            </a>
            <a href="/scribe-method-book/outline-the-introduction" className="chapter__nav-link chapter__nav-link--next">
