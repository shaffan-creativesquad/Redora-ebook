      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/scribe-method-book/how-to-beat-your-fears-and-finish-your-book" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">How To Beat Your Fears and Finish Your Book</span>
            </a>
            <a href="/scribe-method-book/figure-out-your-book-objectives" className="chapter__nav-link chapter__nav-link--next">
