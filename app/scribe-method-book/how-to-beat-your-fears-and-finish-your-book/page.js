      ...
      <main id="main-content">
        <div className="chapter">
          ...
          <div className="chapter__nav">
            <a href="/scribe-method-book/the-six-fears-you-could-face-writing-your-book" className="chapter__nav-link chapter__nav-link--prev">
              <span className="chapter__nav-label">Previous Chapter</span>
              <span className="chapter__nav-title">The Six Fears You Could Face Writing Your Book</span>
            </a>
            <a href="/scribe-method-book/what-is-book-positioning-and-why-does-it-matter" className="chapter__nav-link chapter__nav-link--next">
