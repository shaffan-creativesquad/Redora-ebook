...
export const metadata = {
  title: 'Author Royalties | The Scribe Blog | Scribe Media',
  description: 'Learn about author royalties, ghostwriting, and how Scribe Media puts authors first with transparent publishing practices.',
}
...
const tags = [
  ...
  { label: 'Author Royalties', href: '/blog/tag/author-royalties', active: true },
  { label: 'Book Topic', href: '/blog/tag/book-topic' },
  { label: 'Speaking', href: '/blog/tag/speaking' },
]

export default function AuthorRoyaltiesTagPage() {
  return (
    <>
      <Navbar />
