...
export const metadata = {
  title: 'Book Positioning | The Scribe Blog | Scribe Media',
  description: 'Expert book positioning insights from 2,000+ published authors. Learn how to position your book to reach the right readers and grow your business.',
}
...
const tags = [
  ...
  { label: 'Book Positioning', href: '/blog/tag/book-positioning', active: true },
...
export default function BookPositioningTagPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="blog-listing">
          ...
          <BlogTagGrid featured={data.featured} posts={data.posts} totalPages={1} />
