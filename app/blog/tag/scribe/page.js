...
export const metadata = {
  title: 'Scribe | The Scribe Blog | Scribe Media',
  description: 'News, updates, and stories from Scribe Media. Follow our journey helping 2,000+ authors write, publish, and market their books.',
}
...
const tags = [
  ...
  { label: 'Scribe', href: '/blog/tag/scribe', active: true },
...
export default function ScribeTagPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="blog-listing">
          ...
          <BlogTagGrid featured={data.featured} posts={data.posts} paginationBase="/blog/tag/scribe" totalPages={2} />
