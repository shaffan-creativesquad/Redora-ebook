...
export const metadata = {
  title: 'Book Marketing | The Scribe Blog | Scribe Media',
  description: 'Expert book marketing insights from 2,000+ published authors. Strategies to help you launch and market your nonfiction book.',
}
...
const tags = [
  ...
  { label: 'Book Marketing', href: '/blog/tag/book-marketing', active: true },
...
export default function BookMarketingTagPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="blog-listing">
          ...
          <BlogTagGrid featured={data.featured} posts={data.posts} paginationBase="/blog/tag/book-marketing" totalPages={7} />
