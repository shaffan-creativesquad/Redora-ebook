...
export const metadata = {
  title: 'Book Topic | The Scribe Blog | Scribe Media',
  description: 'Book Topic | Expert insights on book writing, publishing, editing, and marketing from Scribe Media. Tips and strategies for entrepreneurs and professionals writing nonfiction books.',
}
...
const tags = [
  ...
  { label: 'Book Topic', href: '/blog/tag/book-topic', active: true },
  { label: 'Speaking', href: '/blog/tag/speaking' },
]

export default function BookTopicTagPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="blog-listing">
          ...
          <BlogTagGrid featured={data.featured} posts={data.posts} paginationBase="/blog/tag/book-topic" totalPages={1} />
