...
export const metadata = {
  title: 'Speaking | The Scribe Blog | Scribe Media',
  description: 'Speaking | Expert insights on book writing, publishing, editing, and marketing from Scribe Media. Tips and strategies for entrepreneurs and professionals writing nonfiction books.',
}
...
const tags = [
  ...
  { label: 'Speaking', href: '/blog/tag/speaking', active: true },
]

export default function SpeakingTagPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="blog-listing">
          ...
          <BlogTagGrid featured={data.featured} posts={data.posts} paginationBase="/blog/tag/speaking" totalPages={1} />
