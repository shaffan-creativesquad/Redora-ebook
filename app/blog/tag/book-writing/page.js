...
import BlogTagGrid from './BlogTagGrid'
import data from './posts.json'

export const metadata = {
  title: 'Book Writing | The Scribe Blog | Scribe Media',
  description: 'Expert insights on book writing from 2,000+ published authors. Strategies and stories to help you write your nonfiction book.',
}

const tags = [
  { label: 'All Posts', href: '/blog' },
  { label: 'Book Writing', href: '/blog/tag/book-writing', active: true },
...
export default function BookWritingTagPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="blog-listing">
          ...
          <BlogTagGrid featured={data.featured} posts={data.posts} />
