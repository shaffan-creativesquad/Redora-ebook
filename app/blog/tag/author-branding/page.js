...
export const metadata = {
  title: 'Author Branding | The Scribe Blog | Scribe Media',
  description: 'Expert author branding insights from 2,000+ published authors. Build your platform, grow your audience, and establish your authority.',
}
...
const tags = [
  ...
  { label: 'Author Branding', href: '/blog/tag/author-branding', active: true },
...
export default function AuthorBrandingTagPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="blog-listing">
          ...
          <BlogTagGrid featured={data.featured} posts={data.posts} paginationBase="/blog/tag/author-branding" totalPages={2} />
