...
export const metadata = {
  title: 'Book Bites | The Scribe Blog | Scribe Media',
  description: 'Short excerpts and bite-sized insights from published Scribe authors. Discover your next great read.',
}
...
const tags = [
  ...
  { label: 'Book Bites', href: '/blog/tag/book-bites', active: true },
...
export default function BookBitesTagPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="blog-listing">
          ...
          <BlogTagGrid featured={data.featured} posts={data.posts} paginationBase="/blog/tag/book-bites" totalPages={8} />
