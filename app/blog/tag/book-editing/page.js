...
export const metadata = {
  title: 'Book Editing | The Scribe Blog | Scribe Media',
  description: 'Expert book editing insights from 2,000+ published authors. Tips on editing, proofreading, beta readers, and manuscript formatting.',
}
...
const tags = [
  ...
  { label: 'Book Editing', href: '/blog/tag/book-editing', active: true },
...
export default function BookEditingTagPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="blog-listing">
          ...
          <BlogTagGrid featured={data.featured} posts={data.posts} paginationBase="/blog/tag/book-editing" totalPages={2} />
