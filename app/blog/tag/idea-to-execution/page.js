...
export const metadata = {
  title: 'Idea to Execution | The Scribe Blog | Scribe Media',
  description: 'From idea to published book — expert insights on turning your knowledge into a nonfiction book that builds credibility and grows your business.',
}
...
const tags = [
  ...
  { label: 'Idea to Execution', href: '/blog/tag/idea-to-execution', active: true },
...
export default function IdeaToExecutionTagPage() {
  return (
    <>
      <Navbar />
