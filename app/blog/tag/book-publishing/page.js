...
export const metadata = {
  title: 'Book Publishing | The Scribe Blog | Scribe Media',
  description: 'Expert insights on book publishing from 2,000+ published authors. Strategies and stories to help you publish your nonfiction book.',
}
...
const tags = [
  ...
  { label: 'Book Publishing', href: '/blog/tag/book-publishing', active: true },
...
export default function BookPublishingTagPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="blog-listing">
          ...
          <BlogTagGrid featured={data.featured} posts={data.posts} paginationBase="/blog/tag/book-publishing" totalPages={9} />
