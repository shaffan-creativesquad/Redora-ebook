...
export const metadata = {
  title: 'Shep Hyken | Scribe Media Author',
  description:
    'Shep Hyken is a published Scribe Media author. In fact, amazement is a habit that anyone can master--and Shep Hyken knows the tricks to making it your own.',
}

export default function ShepHykenAuthorPage() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="author-detail">
          ...
          <div className="author-detail__header">
            <div className="author-detail__avatar-wrap">
              <Image
                ...
                unoptimized
              />
              <span className="author-detail__initials author-detail__initials--fallback">SH</span>
            </div>
            <div className="author-detail__info">
              <h1 className="author-detail__name">Shep Hyken</h1>
              ...
              <div className="author-detail__links">
                <a
                  href="https://www.amazon.com/dp/096378207X?tag=scribemedia0a-20"
          ...
          <div className="author-detail__stats-bar">
            ...
            <div className="author-detail__stat">
              <div className="author-detail__stat-value">243</div>
          ...
          <div className="author-detail__section">
            <h2 className="author-detail__section-title">About Shep</h2>
          ...
          <div className="author-detail__section">
            ...
            <div className="author-detail__books-grid">
              <Link href="/published-books/be-amazing-or-go-home" className="author-detail__book-card">
                <div className="author-detail__book-cover-wrap">
                  <span className="author-detail__book-card-badge">🏆 Bestseller</span>
                  <Image
                    src="https://scribemedia.com/hs-fs/hubfs/images/books/be-amazing-or-go-home.jpg?width=264&height=406&name=be-amazing-or-go-home.jpg"
                ...
                <div className="author-detail__book-card-info">
                  <p className="author-detail__book-card-title">Be Amazing or Go Home</p>
          ...
          <div className="author-detail__cta-section">
            ...
            <p className="author-detail__cta-text">
              Join Shep and 2,000+ authors who have published with Scribe Media.
            </p>
