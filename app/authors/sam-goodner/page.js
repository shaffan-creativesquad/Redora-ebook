...
export const metadata = {
  title: 'Sam Goodner | Scribe Media Author',
  description:
    'Sam Goodner is a serial entrepreneur and former Swiss Army officer. Author of Like Clockwork, a guide to the strategies and systems behind building and scaling multimillion-dollar companies.',
}

export default function SamGoodnerAuthorPage() {
  return (
    <>
      <Navbar />
        ...
        <div className="author-detail">
          ...
          <div className="author-detail__header">
            ...
            <div className="author-detail__info">
              <h1 className="author-detail__name">Sam Goodner</h1>
              ...
              <div className="author-detail__links">
                <a
                  href="https://www.amazon.com/dp/1544548605?tag=scribemedia0a-20"
                ...
                <a
                  href="https://www.linkedin.com/in/samgoodner/"
          ...
          <div className="author-detail__stats-bar">
            ...
            <div className="author-detail__stat">
              <div className="author-detail__stat-value">41</div>
          ...
          <div className="author-detail__section">
            <h2 className="author-detail__section-title">About Sam</h2>
            <div className="author-detail__bio">
              <p>
                Few actually achieve it. In <em>Like Clockwork</em>, serial entrepreneur and former
                Swiss Army officer Sam Goodner reveals the strategies and systems behind his decades
                of success in building and scaling multimillion-dollar companies.
              </p>
            </div>
          </div>
          ...
          <div className="author-detail__section">
            ...
            <div className="author-detail__books-grid">
              <Link
                href="/published-books/like-clockwork"
              ...
              >
                <div className="author-detail__book-cover-wrap">
                  ...
                  <Image
                    src="https://scribemedia.com/hs-fs/hubfs/images/books/61VQRvSXUqL._SL1360_.jpg"
                    alt="Like Clockwork"
                    width={264}
                    height={406}
                ...
                <div className="author-detail__book-card-info">
                  <p className="author-detail__book-card-title">Like Clockwork</p>
          ...
          <div className="author-detail__cta-section">
            ...
            <p className="author-detail__cta-text">
              Join Sam and 2,000+ authors who have published with Scribe Media.
            </p>
