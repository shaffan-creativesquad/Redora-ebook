...
export const metadata = {
  title: "Ron Thurston Used Scribe to Celebrate America's Unsung Heroes (And Launched a New Career Along the Way) | Scribe Media",
  description:
    'With a true love for retail, Ron Thurston changes the narrative for industry workers around the world. Read more on the Scribe blog.',
}

export default function RonThurstonRetailPrideSuccessStory() {
  return (
    <>
      <Navbar />
      <main id="main-content">
        <div className="ss-detail">
          ...
          <div className="ss-detail__meta">
            <a className="ss-detail__tag ss-detail__tag--goal" href="/success-stories?goal=Attract+new+clients"><i className="ph ph-target"></i> Attract new clients</a>
            <a className="ss-detail__tag ss-detail__tag--goal" href="/success-stories?goal=Change+people%27s+lives"><i className="ph ph-target"></i> Change people&apos;s lives</a>
            <a className="ss-detail__tag ss-detail__tag--goal" href="/success-stories?goal=Differentiate+from+competition"><i className="ph ph-target"></i> Differentiate from competition</a>
            <a className="ss-detail__tag ss-detail__tag--goal" href="/success-stories?goal=Guide+others+through+hardship"><i className="ph ph-target"></i> Guide others through hardship</a>
            <a className="ss-detail__tag ss-detail__tag--goal" href="/success-stories?goal=Leave+a+legacy"><i className="ph ph-target"></i> Leave a legacy</a>
            <a className="ss-detail__tag ss-detail__tag--goal" href="/success-stories?goal=Secure+speaking+engagements"><i className="ph ph-target"></i> Secure speaking engagements</a>
            <a className="ss-detail__tag ss-detail__tag--goal" href="/success-stories?goal=Start+consulting+practice"><i className="ph ph-target"></i> Start consulting practice</a>
            <a className="ss-detail__tag ss-detail__tag--fear" href="/success-stories?fear=I+won%27t+get+ROI"><i className="ph ph-shield-check"></i> ROI Achieved</a>
            <a className="ss-detail__tag ss-detail__tag--fear" href="/success-stories?fear=Lack+of+time"><i className="ph ph-shield-check"></i> Tight Timeline Met</a>
          </div>
          ...
          <div className="ss-detail__content">
            <p>To say that Ron Thurston loves retail is an understatement.</p>
            {/* <!--more--> */}
            <p>For him, it&apos;s a way of life. He&apos;s spent over 20 years working in the industry, and he&apos;s seen the impact it has on people every single day. Like so many other retail workers, his career started accidentally. He started working at a store in the mall, then moved up to manager, then district manager. Eventually, he climbed all the way to Vice President of Stores.</p>
            <p>Along the way, he saw the joy on people&apos;s faces when they came in to shop. He saw the people buying gifts for a loved one, the teenagers spending a day at the mall with their friends. He watched them step out of the day-to-day hustle, unwind, and pamper themselves.</p>
            <p>He saw firsthand the role retail played in his colleagues&apos; lives, too. It was a way to support their families, put themselves through school, and buy cars and houses. The benefits weren&apos;t just financial, either: he and his coworkers loved connecting with customers.</p>
            <p>That&apos;s why, even though Ron didn&apos;t set out to have a career in retail, he stayed. He loved it, just like the people around him loved it. And it&apos;s also why, whenever he would hear the question, &quot;When are you going to get a <em>real</em> job?&quot;, it drove him crazy. He <em>had</em> a real job: a career in retail.</p>
            ...
            <em>&quot;There was nothing that celebrates people in the industry, or recognizes their hard work or says what they&apos;re doing is amazing. Those workers, along with our industry, desperately needed that.&quot;</em>
            <p>As a manager and executive, he could help his own teams regain pride in their work, but he wanted to reach the millions of other workers out there. He wasn&apos;t sure what to do until he stumbled on a weekend workshop put on by his men&apos;s group. It was all about legacy: how could he have the greatest possible impact on the world?</p>
            <p>Everything he&apos;d been thinking and experiencing for the past 20 years crystallized at that workshop. By the end of the weekend, he knew exactly what he had to do: write a book that would celebrate retail workers, give voice to what they were feeling, and prove to the world that what they were doing was far more than just a placeholder job.</p>
            <h2>Ron had a dream, but he had no idea how to get started.</h2>
            <p>Ron was crystal clear on who the book was for: a store manager in a mall in small-town America who had accidentally stumbled into retail and absolutely loved it. He wanted to give that manager a voice, a way to respond to the people who dismissed her career.</p>
            <p>He had professional goals for the book too. He wanted to build a platform and a brand around himself, to become one of the go-to thought leaders in brick-and-mortar retail and its future.</p>
            ...
            <em>&quot;That lasted for a week, and then I realized, What am I waiting for? I&apos;m going to do this, and I&apos;m going to do it now.&quot;</em>
            <p>Ron booked one of the last slots for Scribe&apos;s October 2019 Guided Author workshop. He loved the idea of being able to drive most of the book himself, while still benefiting from the expertise of a proven writing, publishing, and marketing team.</p>
            <p>But it wasn&apos;t long before his self-doubt kicked in. Was what he had to say interesting or valid? Would people find him credible? Did he have the skill to write and publish a book?</p>
            <p>Those weren&apos;t his only concerns, either. He knew from his experience in retail that October was the best time to release a book, but that was just a year away. To launch in October would take a lot of work, and he had a full-time job. He didn&apos;t know if he could do it.</p>
            <h2>Scribe&apos;s process eased all of Ron&apos;s fears.</h2>
            <p>Ron committed fully to Scribe&apos;s process, from how much to write each day to how to write his drafts. His team was there for him every step of the way. They helped him organize his book, worked with him to hone and refine his message, and kept him on his timeline.</p>
            <p>But it wasn&apos;t just the Scribe team that helped him. His greatest support came from a place he didn&apos;t expect: the other people in the workshop.</p>
            ...
            <p>And now that he can give it his full attention, the opportunities just keep growing.</p>
            <em>&quot;It&apos;s become my full-time work, which was my dream.&quot;</em>
            <h2>Ron&apos;s greatest measure of success is the impact the book has made on retail workers.</h2>
            <p>The most important outcome for Ron, though, is the impact the book has made on the people working in retail. He started this journey for them, to help them celebrate their work in brick-and-mortar retail. And because of him, people around the world suddenly saw their jobs in a whole new light. It reignited a fire in them, and the impact continues to grow.</p>
            <em>&quot;I just got a note from a store manager thanking me for helping him create a trusting environment where people are free to be proud of what they do.&quot;</em>
            <p>Ron gets hundreds of those kinds of messages, and they show him that writing the book was 100 percent worth it. He set out to help an entire industry recapture the pride they felt in themselves and in their work. And every time someone tells him that, for the first time, they feel like someone understands them, he smiles.</p>
            ...
            {/* <!--fwp-loop--> */}
            <p><a href="https://scribemedia.com/success-stories/how-tim-urban-wait-but-why-turned-an-epic-blog-post-into-a-print-masterpiece-with-scribe">How Tim Urban (Wait But Why) Turned an Epic Blog Post into a Print Masterpiece with Scribe</a></p>
            <p><a href="https://scribemedia.com/success-stories/kyle-thiermann-one-last-question-before-you-go">How Kyle Thiermann Turned a Viral Podcast Moment into a Breakout Debut Book and a Launch Built on Generosity</a></p>
            <p><a href="https://scribemedia.com/success-stories/how-shark-tank-winner-shaan-patel-leveraged-a-book-launch-to-drive-record-revenue-for-prep-expert">How Shark Tank Winner Shaan Patel Leveraged a Book Launch to Drive Record Revenue for Prep Expert</a></p>
            <a href="/blog/category/author-success-study">
